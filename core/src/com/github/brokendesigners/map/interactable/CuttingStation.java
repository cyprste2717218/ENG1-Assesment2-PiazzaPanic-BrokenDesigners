...
import com.github.brokendesigners.bubble.CuttingBubble;
import com.github.brokendesigners.item.Item;
import com.github.brokendesigners.item.ItemRegister;

import com.github.brokendesigners.renderer.BubbleRenderer;
import com.github.brokendesigners.timer.TimerManager;
...
public class CuttingStation extends Station {
    ...
    public CuttingStation(Vector2 objectPosition, float width, float height, float handX, float handY, BubbleRenderer bubbleRenderer){
        ...
        this.bubble = new CuttingBubble(bubbleRenderer, new Vector2(handPosition.x - 8f * Constants.UNIT_SCALE, handPosition.y));
